...
import { AnimatePresence, type HTMLMotionProps, motion, type TargetAndTransition, useMotionValue, useSpring } from 'motion/react';
...
interface ExpandableContextType {
  ...
  easeType: 'easeInOut' | 'easeIn' | 'easeOut' | 'linear' | [number, number, number, number]; // Easing function for the animation
...
const getAnimationProps = (preset: keyof typeof ANIMATION_PRESETS | undefined, animateIn?: AnimationProps, animateOut?: AnimationProps) => {
...
>(({ children, preset, animateIn, animateOut, stagger = false, staggerChildren = 0.1, keepMounted = false, ...props }, ref) => {
      ...
      <motion.div
        ...
        <div
          ...
          <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 sm:p-1.5 md:p-2 shadow-md">
            <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white dark:bg-neutral-100 p-2 sm:p-3 md:p-4 shadow-xl ring-1 ring-neutral-200/50 dark:bg-neutral-950 dark:ring-neutral-800/50">
...
const ExpandableTrigger = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ children, className, ...props }, ref) => {
...
const ExpandableCardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, children, ...props }, ref) => (
...
const ExpandableCardContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, children, ...props }, ref) => (
